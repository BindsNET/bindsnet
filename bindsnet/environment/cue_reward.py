...
class CueRewardSimulator():
    ...
    def step(self, action):
        ...
        if(self.trialTime <= 0):
            ...
            self.pairmask = np.array(range(NUM_CUES))[np.argsort(np.random.uniform(0,1,4)) < 2]
    ...
    def reset(self):
        ...
        # Reset reward
        self.reward = torch.Tensor(1); self.reward[0] = 0     # default reward to 0
